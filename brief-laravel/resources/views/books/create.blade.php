<x-layout>
    ...
    <form method="POST" action="/books" class="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg">
        @csrf
        <div class="space-y-12">
            <div class="border-b border-gray-300 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex items-center rounded-md bg-gray-100 pl-3 focus-within:outline-2 focus-within:outline-indigo-500">
                                <input type="number" min="120" max="53000" name="price" id="price"
                                    class="block w-full py-2 pr-3 px text-lg text-gray-900 placeholder-gray-500 focus:outline-none sm:text-lg"
                                    placeholder="e.g. 555">
                            </div>
                        </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit"
                        class="bg-indigo-600 px-4 py-2 text-lg font-semibold text-white rounded-md shadow-md hover:bg-indigo-500 focus:ring-4 focus:ring-indigo-300">Save</button>
                </div>
            </div>
        </div>
    </form>
