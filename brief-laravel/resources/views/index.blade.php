...
<body class="bg-gray-50">
    ...
    <section class="container mx-auto py-16 px-6">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600">Explorez des milliers de livres, gérez vos emprunts et suivez vos lectures.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
                ...
                <p class="text-gray-600 mb-4">Explorez notre large sélection de livres. Trouvez votre prochain livre préféré !</p>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
                ...
                <p class="text-gray-600 mb-4">Mettez à jour vos informations personnelles, suivez vos emprunts et vos lectures.</p>
                <a href="{{ route('users.show', Auth::id()) }}" class="text-indigo-600 hover:text-indigo-800">Accéder à votre profil</a>
            </div>

            <!-- Option 3: S'inscrire ou Se connecter -->
            <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">Commencez à lire</h3>
                <p class="text-gray-600 mb-4">Créez un compte ou connectez-vous pour accéder à nos services de bibliothèque en ligne.</p>
                <div class="space-x-4">
                    <a href="{{ route('register') }}" class="py-2 px-4 bg-green-600 text-white rounded-lg hover:bg-green-700">S'inscrire</a>
                    <a href="{{ route('login') }}" class="py-2 px-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Se connecter</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/150" alt="Livre" class="w-full h-48 object-cover rounded-t-lg mb-4">
                    <h3 class="text-xl font-semibold text-gray-800">Titre du Livre</h3>
                    <p class="text-gray-600">Une brève description du livre. Ce livre est très apprécié par nos lecteurs.</p>
                </div>
                <!-- Livre 2 -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/150" alt="Livre" class="w-full h-48 object-cover rounded-t-lg mb-4">
